...
```{r, figures-side, fig.show="hold", out.width="30%", echo = F, fig.cap = "Spot Prices"}
...
```{r revcost, echo=FALSE, out.width = "50%", fig.cap = "Profits, Long Spot and Short Hedge ($/bu)", fig.align='center'}
knitr::include_graphics("Images/Revenue_Cost.jpeg")
```

Figure \@ref(fig:overlay-cm) shows 

```{r overlay-cm, echo=FALSE, out.width="30%", fig.cap = "Profits, Long Spot and Short Hedge ($/bu)", fig.align='center'}
